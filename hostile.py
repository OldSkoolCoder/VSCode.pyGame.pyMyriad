...
class Hostile(element.Element):
    ...
    def __init__(self,game,HostileNo,Wave,myValue=100,Scale=0.5,myHitValue=2):
        ...
        self.imDead = False
        self.myValue = (myValue * game.gameDifficulty) * self.game.gameMultiplier
        ...
        self.prevdY = 0
        self.prevdX = 0
        self.hitValue = myHitValue * game.gameDifficulty
