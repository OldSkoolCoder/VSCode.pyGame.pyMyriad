...
class Meteor(element.Element):
    def __init__(self,game,X=-50,Y=-50):

        super().__init__(game,X,Y,'')

        meteorSet = "ABCDEFGHI"[random.randint(0,8)]
        ...
        #super().loadAnimationSeries(f'Meteor{meteorSet}-',self.noOfFrames)
        self.animation = self.game.assets.animationsSets['Meteor'][f'Set{meteorSet}'].copy()
